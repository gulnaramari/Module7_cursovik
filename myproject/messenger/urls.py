...
urlpatterns = [
    ...
    path('recipient/create/', RecipientCreateView.as_view(), name='recipient_form'),
    ...
    path('mailing/<int:pk>/deactivate/', MailingDeactivateView.as_view(), name='mailing_deactivate'),
